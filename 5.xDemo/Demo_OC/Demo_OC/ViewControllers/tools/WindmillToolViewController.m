...
@interface WindmillToolViewController ()<CLLocationManagerDelegate>
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) CLLocationManager *locationManager;
@end

@implementation WindmillToolViewController
...
- (void)initializeForm {
    ...
    section.title = @"设备ID";
    section.footerTitle = @"UId是ToBid内部ID，开发者技术对接可以使用该ID快速定位问题。";
    
    row = [XLFormRowDescriptor formRowDescriptorWithTag:kUid rowType:XLFormRowDescriptorTypeButton title:@"UId"];
